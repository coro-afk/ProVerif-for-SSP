...
echo "27. Verifying dual passkey entry mode "
prepare "27" "DPE"
cat $ssp_f > $tmp_f
echo "(step1c(pri_C)) | (step1p(pri_P)) | (step2cdpe()) | (step2pdpe()) | (step3cshm()) | (step3pshm()) | (step4c()) | (step4p()) | (userpecoutpin()) | (userpecinpout())" >> $tmp_f
analyze
echo ""

echo "28. Verifying DPENC mode "
prepare "28" "DPENC"
cat $ssp_f > $tmp_f
echo "((step1c(pri_C)) | (step1p(pri_P)) | (step2cdpenc()) | (step2pdpenc()) | (step3cshm()) | (step3pshm()) | (step4c()) | (step4p()) | (user_dpenc()) | (userpecoutpin()) | (userpecinpout()))" >> $tmp_f
analyze
echo ""

echo "Verifying SSP+DPE+DPENC finished."
